...
with h5py.File(main_filepath+"/"+'preprocessing/Data_Repository' + '/' + 'dataset_mtarsi_rgb_255.hdf5', 'w') as f:
...
with h5py.File(main_filepath+"/"+'preprocessing/Data_Repository' + '/' + 'mean_rgb_dataset_mtarsi.hdf5', 'w') as f:

    f.create_dataset('mean', data=mean_rgb_dataset_custom, dtype='f')

with h5py.File(main_filepath+"/"+'preprocessing/Data_Repository' + '/' + 'dataset_mtarsi_rgb_255_mean.hdf5', 'w') as f:
...
with h5py.File(main_filepath+"/"+'preprocessing/Data_Repository' + '/' + 'std_rgb_dataset_mtarsi.hdf5', 'w') as f:

    f.create_dataset('std', data=std_rgb_dataset_custom, dtype='f')

with h5py.File(main_filepath+"/"+'preprocessing/Data_Repository' + '/' + 'dataset_mtarsi_rgb_255_mean_std.hdf5', 'w') as f:
